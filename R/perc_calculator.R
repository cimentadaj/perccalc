...
#' to estimate que percentile differences
...
#'
#'
#' perc_calculator(toy_data, type, score, percentiles = c(90, 10))
#' perc_calculator(toy_data, type, score, percentiles = c(50, 10))
#'
#' perc_calculator(toy_data, type, score, weights = wt, percentiles = c(30, 10))
#'
