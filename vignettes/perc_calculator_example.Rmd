...
The package only has one function called `perc_diff` and it's very easy to use, we just specify the data, the name of the categorical and continuous variable and the percentile difference we want. 
